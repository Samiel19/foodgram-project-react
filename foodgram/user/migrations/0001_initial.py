    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Юзернейм', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code='Invalid_username', message='Имя пользователя должно состоять из букв и цифр', regex='^[\\w.@+-]+$')], verbose_name='Уникальный юзернейм')),
